...
def patch_stateful_ssm(config: PretrainedConfig, ov_model: ov.Model):
    ...
    ssm_prefix_input_names = ["cache_params.past", "past_key_values.conv_state", "past_key_values.recurrent_state"]
    ...
    ssm_prefix_output_names = ["cache_params.present", "present.conv_state", "present.recurrent_state"]
